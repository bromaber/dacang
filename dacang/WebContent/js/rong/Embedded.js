(function(e, h, c) {
	...
	i.loadCss = function() {
		...
		f.css = [
				...
				".rc_chat .rc_dialog_box_header { height: 33px; line-height: 33px; font-size: 14px; background-color: "
						+ f.style.headerColor
				...
				".rc_right {background-color: "
						+ f.style.bodyColor
						+ "; border-radius: 3px; max-height: 510px; min-height: 510px;position: relative; margin-top: 23px;}",
				...
				".rc_dialog_box .rc_self .rc_msg .rc_msgBody { background-color: "
						+ f.style.cusMsgColor
						+ "; margin-right: 4px; max-width: 300px; float: none; padding: 12px 10px 12px 19px; }",
				...
				".rc_msg_box .rc_input_box .rc_button_box button { width: 80px; background-color: "
						...
						+ "; border-radius: 5px; border: none; height: 34px; color: #fff; font-size: 18px; }",
				".rc_msg_box .rc_input_box .rc_button_box font { color: "
						+ f.style.sendBtnColor + "; font-size: 13px; }",
	...
	i.init = function() {
		...
		if (f.btncss) {
			$("#btn-kefu")[0].setAttribute("style", f.btncss)
		} else {
			var k = "width: 30px; padding: 10px; height: 92px; position: absolute; bottom: 100px; z-index: 999999; right: 30px; border: 1px solid rgb(196, 196, 196); border-radius: 5px; cursor: pointer; color: rgb(14, 180, 216); background-color: #f6f6f6;";
			$("#btn-kefu")[0].setAttribute("style", f.isURL ? "display:none;"
					+ k : "display:block;" + k)
		}
	};
	i.sendMsgCallback = {};
